...
if __name__ == '__main__':
        ...
        #
        mag_mult = 2053 # TODO This is the multiplier value to read the Current used by the Pi.- Need to refine this better
        temp_mult = 1
...
#
        ...
        while (True):
                #   Read Channel 0
                Ch0Value = mag_mult*getreading(address, channel0)
                # print ("Channel 0 at %s is %12.2f" % (time.ctime(), Ch0Value))
                print(Ch0Value)
                time.sleep(tiempo)
                
                Ch1Value = temp_mult*getreading(address, channel1)
                print ("Channel 0 at %s is %12.2f" % (time.ctime(), Ch1Value))
                print(Ch1Value)
                time.sleep(tiempo)

                Ch2Value = temp_mult*getreading(address, channel2)
                # print ("Channel 0 at %s is %12.2f" % (time.ctime(), Ch0Value))
                print(Ch2Value)
                time.sleep(tiempo)

                Ch3Value = temp_mult*getreading(address, channel3)
                # print ("Channel 0 at %s is %12.2f" % (time.ctime(), Ch0Value))
                print(Ch3Value)
                time.sleep(tiempo)
